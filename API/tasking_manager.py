...
from src.galaxy.tasking_manager.models import ValidatorStatsRequest, ListTeamsRequest, ListTeamsMetadataRequest
...
@router.get("/teams")
def get_teams():
    csv_stream = ListTeamsRequest.list_teams()
...
def get_teams():
    csv_stream = ListTeamsMetadataRequest.list()
